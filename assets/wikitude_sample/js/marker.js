...
function Marker(poiData) {
    ...
    */
    ...
    this.markerDrawableIdle = new AR.ImageDrawable(
        new AR.ImageResource(poiData.businessLogoUrl, {onError: World.onError}),
        poiData.distancePerKm*4, 
        {
            zOrder: 0,
            opacity: 1.0,
            /*
    ...
    this.titleLabel = new AR.Label(
        /*poiData.title.trunc(10)*/ "",
        1, 
        {
            zOrder: 1,
            translate: {
    ...
    this.descriptionLabel = new AR.Label(
        /*poiData.description.trunc(15)*/ "", 
        0.8, 
        {
            zOrder: 1,
            translate: {
    ...
    */
    this.directionIndicatorDrawable = new AR.ImageDrawable(
        new AR.ImageResource("assets/indi.png", {onError: World.onError}),
        0.1, 
        {
            enabled: false,
